...
// stage content:
(lib.RECOVER_midterm_grider_UPDATE = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_7.png?1731619213145", id:"CachedBmp_7"},
		{src:"images/CachedBmp_2.png?1731619213145", id:"CachedBmp_2"},
		{src:"images/grider_allHallowsEve_midterm_atlas_1.png?1731619213091", id:"grider_allHallowsEve_midterm_atlas_1"}
	],
	preloads: []
};
